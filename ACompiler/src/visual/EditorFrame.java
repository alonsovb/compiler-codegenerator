...
public class EditorFrame extends javax.swing.JFrame implements Reporter {
    ...
    private List<CodeViewer> subFrames = new LinkedList<CodeViewer>();
    ...
    public void ShowGeneratedFiles(List<String> Files) {
        ...
        for (int i = 0; i < Files.size(); i++) {
            CodeViewer viewer = new CodeViewer(Files.get(i));
            subFrames.add(viewer);
            viewer.setBounds(i * viewer.getMinimumSize().width, 0, viewer.getWidth(), viewer.getHeight());
